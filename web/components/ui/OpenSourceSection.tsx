...
export default function OpenSourceSection() {
  return (
    <section className="w-full py-16 px-4 text-center bg-white">
      <div className="max-w-2xl mx-auto flex flex-col items-center gap-4">
        ...
        <span className="inline-block bg-green-100 text-green-800 dark:bg-green-900 dark:text-green-200 px-2 py-0.5 rounded-full text-xs font-semibold mb-1">OSS</span>
        <h2 className="text-xl md:text-2xl font-black text-slate-900 dark:text-slate-100 mb-2">Open Source, Community-Driven</h2>
        ...
        <p className="text-base text-slate-700 dark:text-slate-300 max-w-xl mx-auto">
          Promptic is fully open source — built to serve the community. We believe in developer extensibility, transparent infrastructure, and a community-driven roadmap. Join us, contribute, and help shape the future of prompt management.
        </p>
      </div>
    </section>
  );
