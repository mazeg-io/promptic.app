  ...
  return (
    <nav className="w-full flex items-center justify-between py-4 px-8 bg-white/80 dark:bg-slate-900/80 backdrop-blur-md border-b border-slate-200 dark:border-slate-800 sticky top-0 z-50">
      ...
      <div className="flex items-center">
        <Image src="/logo.png" alt="Promptic Logo" width={50} height={50} className="rounded-md" />
      </div>
      {/* Nav Links */}
      ...
      <div className="flex gap-2">
        <a href="#getstarted" className="px-4 py-2 rounded-md bg-slate-900 text-white dark:bg-slate-100 dark:text-slate-900 font-semibold hover:bg-slate-700 dark:hover:bg-slate-200" onClick={e => {
          // Redirect to /login
          e.preventDefault();
